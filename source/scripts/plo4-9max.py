"""
PLO4 9MAX EXACT EQUITY ENGINE
Usage:
  python plo4-9max.py hands.txt
  python plo4-9max.py hands.txt --names playermapping.txt
"""
...
EPS = 1e-9
MAX_PLAYERS = 9
NUM_PLAYERS = 9  # overridden from input
HOLE_CARDS = 4
...
if __name__ == "__main__":
    ...
    hdr("PLO4 9MAX EXACT EQUITY ENGINE", Fore.MAGENTA)
    ...
    if not cli["input_file"]:
        err("Usage: python plo4-9max.py hands.txt [--names playermapping.txt]"); sys.exit(1)
    name_map = {}
    if cli["names_file"]:
