"""
PLO6 5MAX EXACT EQUITY ENGINE
Usage:
  python plo6-5max.py hands.txt
  python plo6-5max.py hands.txt --names playermapping.txt
"""
...
if __name__ == "__main__":
    ...
    hdr("PLO6 5MAX EXACT EQUITY ENGINE", Fore.MAGENTA)
    ...
    if not cli["input_file"]:
        err("Usage: python plo6-5max.py hands.txt [--names playermapping.txt]"); sys.exit(1)
    name_map = {}
    if cli["names_file"]:
