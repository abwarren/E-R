"""
PLO7 6MAX EXACT EQUITY ENGINE
Usage:
  python plo7-6max.py hands.txt
  python plo7-6max.py hands.txt --names playermapping.txt
"""
...
if __name__ == "__main__":
    ...
    hdr("PLO7 6MAX EXACT EQUITY ENGINE", Fore.MAGENTA)
    ...
    if not cli["input_file"]:
        err("Usage: python plo7-6max.py hands.txt [--names playermapping.txt]"); sys.exit(1)
    name_map = {}
    if cli["names_file"]:
